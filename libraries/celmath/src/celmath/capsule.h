...
template <class T>
Capsule<T>::Capsule() : origin(0, 0, 0), axis(0, 0, 0), radius(1) {
}

template <class T>
Capsule<T>::Capsule(const Vector3<T>& _axis, T _radius) : origin(0, 0, 0), axis(_axis), radius(_radius) {
}

template <class T>
Capsule<T>::Capsule(const Point3<T>& _origin, const Vector3<T>& _axis, T _radius) :
