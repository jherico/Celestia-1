...
template <class T>
bool testIntersection(const Ray3<T>& ray, const Sphere<T>& sphere, T& distanceToTester, T& cosAngleToCenter) {
...
template <class T>
bool testIntersection(const Ray3<T>& ray, const Ellipsoid<T>& ellipsoid, T& distanceToTester, T& cosAngleToCenter) {
