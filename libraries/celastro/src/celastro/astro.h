...
namespace astro
{
    ...
    bool isLengthUnit(std::string unitName);
    bool isTimeUnit(std::string unitName);
    bool isAngleUnit(std::string unitName);
    bool getLengthScale(std::string unitName, double& scale);
    bool getTimeScale(std::string unitName, double& scale);
    bool getAngleScale(std::string unitName, double& scale);
