...
static map<string, RotationModelPtr> CustomRotationModels;
...
GetCustomRotationModel(const std::string& name)
{
    ...
    if (!CustomRotationModelsInitialized)
    {
        ...
        CustomRotationModels["earth-p03lp"] = std::make_shared<EarthRotationModel>();
        
        // IAU rotation elements for the planets
        CustomRotationModels["iau-mercury"] = std::make_shared<IAUPrecessingRotationModel>(281.01, -0.033,
                                                                             61.45, -0.005,
                                                                             329.548, 6.1385025);
        CustomRotationModels["iau-venus"]   = std::make_shared<IAUPrecessingRotationModel>(272.76, 0.0,
                                                                             67.16, 0.0,
                                                                             160.20, -1.4813688);
        CustomRotationModels["iau-earth"]   = std::make_shared<IAUPrecessingRotationModel>(0.0, -0.641,
                                                                             90.0, -0.557,
                                                                             190.147, 360.9856235);
        CustomRotationModels["iau-mars"]    = std::make_shared<IAUPrecessingRotationModel>(317.68143, -0.1061,
                                                                             52.88650, -0.0609,
                                                                             176.630, 350.89198226);
        CustomRotationModels["iau-jupiter"] = std::make_shared<IAUPrecessingRotationModel>(268.05, -0.009,
                                                                             64.49, -0.003,
                                                                             284.95, 870.5366420);
        CustomRotationModels["iau-saturn"]  = std::make_shared<IAUPrecessingRotationModel>(40.589, -0.036,
                                                                             83.537, -0.004,
                                                                             38.90, 810.7939024);
        CustomRotationModels["iau-uranus"]  = std::make_shared<IAUPrecessingRotationModel>(257.311, 0.0,
                                                                             -15.175, 0.0,
                                                                             203.81, -501.1600928);
        CustomRotationModels["iau-neptune"] = std::make_shared<IAUNeptuneRotationModel>();
        CustomRotationModels["iau-pluto"]   = std::make_shared<IAUPrecessingRotationModel>(313.02, 0.0,
                                                                             9.09, 0.0,
                                                                             236.77, -56.3623195);
       
        // IAU elements for satellite of Earth
        CustomRotationModels["iau-moon"] = std::make_shared<IAULunarRotationModel>();
        
        // IAU elements for satellites of Mars
        CustomRotationModels["iau-phobos"] = std::make_shared<IAUPhobosRotationModel>();
        CustomRotationModels["iau-deimos"] = std::make_shared<IAUDeimosRotationModel>();
        
        // IAU elements for satellites of Jupiter
        CustomRotationModels["iau-metis"]    = std::make_shared<IAUPrecessingRotationModel>(268.05, -0.009,
                                                                              64.49, 0.003,
                                                                              346.09, 1221.2547301);
        CustomRotationModels["iau-adrastea"] = std::make_shared<IAUPrecessingRotationModel>(268.05, -0.009,
                                                                              64.49, 0.003,
                                                                              33.29, 1206.9986602);
        CustomRotationModels["iau-amalthea"] = std::make_shared<IAUAmaltheaRotationModel>();
        CustomRotationModels["iau-thebe"]    = std::make_shared<IAUThebeRotationModel>();
        CustomRotationModels["iau-io"]       = std::make_shared<IAUIoRotationModel>();
        CustomRotationModels["iau-europa"]   = std::make_shared<IAUEuropaRotationModel>();
        CustomRotationModels["iau-ganymede"] = std::make_shared<IAUGanymedeRotationModel>();
        CustomRotationModels["iau-callisto"] = std::make_shared<IAUCallistoRotationModel>();
        
        // IAU elements for satellites of Saturn
        CustomRotationModels["iau-pan"]        = std::make_shared<IAUPrecessingRotationModel>(40.6, -0.036,
                                                                                83.5, -0.004,
                                                                                48.8, 626.0440000);
        CustomRotationModels["iau-atlas"]      = std::make_shared<IAUPrecessingRotationModel>(40.6, -0.036,
                                                                                83.5, -0.004,
                                                                                137.88, 598.3060000);
        CustomRotationModels["iau-prometheus"] = std::make_shared<IAUPrecessingRotationModel>(40.6, -0.036,
                                                                                83.5, -0.004,
                                                                                296.14, 587.289000);
        CustomRotationModels["iau-pandora"]    = std::make_shared<IAUPrecessingRotationModel>(40.6, -0.036,
                                                                                83.5, -0.004,
                                                                                162.92, 572.7891000);
        CustomRotationModels["iau-mimas"]     = std::make_shared<IAUMimasRotationModel>();
        CustomRotationModels["iau-enceladus"] = std::make_shared<IAUEnceladusRotationModel>();
        CustomRotationModels["iau-tethys"]    = std::make_shared<IAUTethysRotationModel>();
        CustomRotationModels["iau-telesto"]   = std::make_shared<IAUTelestoRotationModel>();
        CustomRotationModels["iau-calypso"]   = std::make_shared<IAUCalypsoRotationModel>();
        CustomRotationModels["iau-dione"]     = std::make_shared<IAUDioneRotationModel>();
        CustomRotationModels["iau-helene"]    = std::make_shared<IAUHeleneRotationModel>();
        CustomRotationModels["iau-rhea"]      = std::make_shared<IAURheaRotationModel>();
        CustomRotationModels["iau-titan"]     = std::make_shared<IAUTitanRotationModel>();
        CustomRotationModels["iau-iapetus"]   = std::make_shared<IAUIapetusRotationModel>();
        CustomRotationModels["iau-phoebe"]    = std::make_shared<IAUPhoebeRotationModel>();
        
        CustomRotationModels["iau-miranda"]   = std::make_shared<IAUMirandaRotationModel>();
        CustomRotationModels["iau-ariel"]     = std::make_shared<IAUArielRotationModel>();
        CustomRotationModels["iau-umbriel"]   = std::make_shared<IAUUmbrielRotationModel>();
        CustomRotationModels["iau-titania"]   = std::make_shared<IAUTitaniaRotationModel>();
        CustomRotationModels["iau-oberon"]    = std::make_shared<IAUOberonRotationModel>();
    }
