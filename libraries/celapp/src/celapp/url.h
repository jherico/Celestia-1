...
public:
    ...
    Url(const CelestiaCorePtr& appCore, UrlType type = Absolute);
    Url(const CelestiaState& appState, unsigned int version = CurrentVersion, TimeSource _timeSource = UseUrlTime);
    ~Url();
...
public:
    ...
    void captureState(const CelestiaCorePtr& appCore);
