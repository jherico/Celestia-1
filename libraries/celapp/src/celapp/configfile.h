...
public:
    using Pointer = std::shared_ptr<CelestiaConfig>;
...
using CelestiaConfigPtr = std::shared_ptr<CelestiaConfig>;

CelestiaConfigPtr ReadCelestiaConfig(const std::string& filename);

CelestiaConfigPtr ReadCelestiaConfig(const std::string& filename, CelestiaConfigPtr& config);
