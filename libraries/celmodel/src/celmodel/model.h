...
public:
    ...
    Material::Pointer getMaterial(uint32_t index) const;
    void setMaterial(uint32_t index, const Material::Pointer& material);
    uint32_t addMaterial(const Material::Pointer& material);
     ...
     */
    Mesh::Pointer getMesh(uint32_t index) const;
     ...
     */
    uint32_t addMesh(const Mesh::Pointer& mesh);
    ...
    static MeshComparator OpacityComparator;
#if 0
